...
function PersonalTask() {
    ...
    return <Wrapper>
        <div className={classes.personalTask}>
            <div style={{paddingBottom: 24}}>
                ...
                <div className={classes.info}>
                    <div className={classes.infoCard}>
                        <h4 className={classes.infoTitle}>During the Rewards Period you will be offered with your
                            personal
                    ...
                    <div className={classes.infoCard}>
                        <h4 className={classes.infoTitle}>The complexity of your tasks will increase with the new weekly
                            tasks. The rewards for completing more difficult tasks will increase proportionally. F.e.,
                            the
